...
async def validation_exception_handler(request: Request, exc: RequestValidationError):
    ...
    return JSONResponse(
        ...
        content={
            "error": {
                "code": "INVALID_PACKET",
                "message": f"Schema/field validation failed: {exc.errors()}",
...
# Dynamically calculate the frontend directory path relative to this file
...
async def serve_victim():
    return FileResponse(os.path.join(FRONTEND_DIR, "victim.html"))
